...
const relatedTools = [
  { Icon: PhotoIcon,        name: 'JPG to PNG',    href: '/jpg-to-png',   description: 'Convert JPG images to PNG' },
...
export default function PngToJpg() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const result = await fileApi.createConvertJob(file, 'png', 'jpg');
  ...
  return (
    <>
      <Head>
        <title>PNG to JPG Converter Online Free – No Signup | FilePro</title>
        <meta name="description" content="Convert PNG to JPG online free in seconds. No signup, no email required. Smaller file size for web and email. Files auto-deleted for privacy." />
        <meta name="keywords" content="png to jpg converter, png to jpeg, convert png to jpg online free, png to jpg free, reduce image size png to jpg" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://filepro.neobize.com/png-to-jpg" />
        <meta property="og:title" content="PNG to JPG Converter Online Free – No Signup | FilePro" />
        <meta property="og:description" content="Convert PNG to JPG online for free. Smaller file size for web use. No registration required." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://filepro.neobize.com/png-to-jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="PNG to JPG Converter Free – FilePro" />
        <meta name="twitter:description" content="Convert PNG to JPG online free. Reduce image file size. No signup required." />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          '@context': 'https://schema.org', '@type': 'HowTo',
          name: 'How to Convert PNG to JPG Online Free',
          description: 'Convert PNG images to JPG format online in seconds, free, no registration required.',
          step: [
            { '@type': 'HowToStep', position: 1, name: 'Upload your PNG image', text: 'Click or drag and drop your PNG file (up to 20MB on free plan).' },
            { '@type': 'HowToStep', position: 2, name: 'Click Convert to JPG', text: 'Click the Convert to JPG button. FilePro converts your PNG to the widely compatible JPG format.' },
            { '@type': 'HowToStep', position: 3, name: 'Download your JPG', text: 'Your JPG file is ready in seconds. Click Download to save it.' },
          ],
        }) }} />
      </Head>
      ...
      <div className="min-h-screen bg-primary-50/30 py-14">
        <div className="mx-auto max-w-2xl px-4 sm:px-6">
          ...
          <div className="mb-10 text-center">
            ...
            <h1 className="text-4xl font-bold text-primary-900">PNG to JPG Converter</h1>
            <p className="mt-2 text-slate-500">
              Convert PNG images to JPG for smaller file sizes — free, no signup
            </p>
          </div>
