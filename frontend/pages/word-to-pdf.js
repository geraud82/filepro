...
const relatedTools = [
  { Icon: DocumentTextIcon, name: 'PDF to Word', href: '/pdf-to-word', description: 'Convert PDF back to editable DOCX' },
  { Icon: ArchiveBoxIcon,   name: 'Compress PDF', href: '/compress-pdf', description: 'Reduce PDF file size' },
  { Icon: PhotoIcon,        name: 'JPG to PNG',   href: '/jpg-to-png',  description: 'Convert image formats' },
];

const featureItems = [
  '100% free — no hidden costs',
  'Converts in seconds',
  'Generates universally readable PDF',
...
export default function WordToPdf() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const result = await fileApi.createConvertJob(file, 'docx', 'pdf');
  ...
  return (
    <>
      <Head>
        <title>Word to PDF Converter Online Free – No Signup | FilePro</title>
        <meta name="description" content="Convert Word (.docx) to PDF online free in seconds. No signup, no email required. Preserves fonts and layout. Files auto-deleted for privacy." />
        <meta name="keywords" content="word to pdf converter, docx to pdf, convert word to pdf online free, word to pdf free, save word as pdf" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://filepro.neobize.com/word-to-pdf" />
        <meta property="og:title" content="Word to PDF Converter Online Free – No Signup | FilePro" />
        <meta property="og:description" content="Convert Word documents to PDF online for free. No registration, preserves fonts and layout." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://filepro.neobize.com/word-to-pdf" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Word to PDF Converter Free – FilePro" />
        <meta name="twitter:description" content="Convert DOCX to PDF online free. No signup required. Instant conversion." />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          '@context': 'https://schema.org', '@type': 'HowTo',
          name: 'How to Convert Word to PDF Online Free',
          description: 'Convert Word (.docx) documents to PDF online in seconds, free, no registration required.',
          step: [
            { '@type': 'HowToStep', position: 1, name: 'Upload your Word file', text: 'Click or drag and drop your DOCX file (up to 20MB on free plan).' },
            { '@type': 'HowToStep', position: 2, name: 'Click Convert to PDF', text: 'Click the Convert to PDF button. FilePro converts your Word document to a universally readable PDF.' },
            { '@type': 'HowToStep', position: 3, name: 'Download your PDF', text: 'Your PDF file is ready in seconds. Click Download to save it.' },
          ],
        }) }} />
      </Head>
      ...
      <div className="min-h-screen bg-primary-50/30 py-14">
        <div className="mx-auto max-w-2xl px-4 sm:px-6">
          ...
          <div className="mb-10 text-center">
            ...
            <h1 className="text-4xl font-bold text-primary-900">Word to PDF Converter</h1>
            <p className="mt-2 text-slate-500">
              Convert Word documents to PDF format in seconds — free, no signup
            </p>
          </div>
          ...
          <div className="mt-14 rounded-2xl border border-gray-100 bg-white p-8">
            <h2 className="mb-6 text-2xl font-bold text-primary-900">How to Convert Word to PDF Online</h2>
